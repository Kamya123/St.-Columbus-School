// frontend/src/components/SchoolInfrastructureTable.jsx
...
const SchoolInfrastructureTable = () => {
  ...
  useEffect(() => {
    axios
      .get(`${import.meta.env.VITE_API_BASE_URL}/schoolinfra`)
      .then((res) => setSchoolInfrastructureInfo(res.data))
      .catch((err) => console.error("Error fetching schoolInfrastructure info", err));
  }, []);

  return (
    <div className="p-4 uppercase">
      <h2 className="font-georgia text-2xl text-customRed1 border-b-2 border-b-customRed1 mb-8">
        D: SchoolInfrastructure (Teaching)
      </h2>
      <div className="overflow-x-auto">
        <table className="min-w-full table-fixed border-collapse border border-gray-300">
          ...
          <tbody className="bg-white">
            {schoolInfrastructureInfo.map((info, i) => (
              <tr key={info._id}>
