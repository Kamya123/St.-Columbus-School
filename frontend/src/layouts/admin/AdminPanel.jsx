...
const AdminPanel = () => {
  ...
  const handleImageUpload = async (e) => {
    ...
    try {
      ...
      setUploadMessage("Image uploaded successfully!"); // Set success message after upload
    } catch (error) {
      console.error("Image upload failed:", error);
      setUploadMessage("Image upload failed. Please try again."); // Optionally set an error message
    }
  };
              ...
              {uploadMessage && (
                <div className="mt-6">
                  ...
                  <button
                    ...
                    className="mt-4 bg-blue-500 text-white px-8 py-3 rounded-lg hover:bg-blue-600 transition"
                  >
                    View Gallery
                  </button>
                </div>
