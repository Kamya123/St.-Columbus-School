...
// frontend/src/components/AdminStaffTable.jsx
...
const AdminStaffTable = () => {
  ...
  // Delete a staff info record
  const handleDelete = async (id) => {
    if (window.confirm("Are you sure you want to delete this record?")) {
      try {
        await axios.delete(
          `${import.meta.env.VITE_API_BASE_URL}/staffs/${id}`,
  ...
  // Update a staff info record
  const handleUpdate = async (e) => {
    e.preventDefault();
    try {
      await axios.put(
        `${import.meta.env.VITE_API_BASE_URL}/staffs/${editingId}`,
        editFormData,
        {
          headers: {
